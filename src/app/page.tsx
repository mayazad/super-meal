...
import { ArrowRight, Calculator, Lock, Link as LinkIcon, ShieldCheck, Sparkles, LogIn, Menu, X, ClipboardList, Users, Share2, ChevronDown } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#FDFEFD] text-[#1A2F1A] font-sans selection:bg-[#10B981]/20 overflow-x-hidden relative">
      ...
      <main className="pt-20 sm:pt-32 pb-16 px-4 sm:px-6 w-full relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-5 sm:space-y-8">
          ...
          {!userLoggedIn && (
            <div className="pt-2">
              <Link href="/register" className="inline-flex items-center gap-2 bg-[#10B981] hover:bg-[#059669] text-white px-8 py-3.5 rounded-full font-bold text-base transition-all shadow-lg hover:-translate-y-0.5 hover:shadow-xl">
        ...
        {/* ── Stat Bar ──────────────────────────────────── */}
        <div className="max-w-3xl mx-auto mt-14 sm:mt-20 grid grid-cols-3 gap-4 sm:gap-8">
          {[
            { value: '100%', label: 'Free to Use' },
            { value: 'Auto', label: 'Meal Rate Calc' },
            { value: '0 Tk', label: 'Billing Disputes' },
          ].map(({ value, label }) => (
            <div key={label} className="text-center">
              <p className="text-2xl sm:text-4xl font-extrabold text-[#10B981]">{value}</p>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 bg-white border-t border-[#D1EAD8]">
        <div className="max-w-2xl mx-auto text-center space-y-5">
          ...
          <div className="pt-2">
            <Link href="/register" className="inline-flex items-center gap-2 bg-[#064E3B] hover:bg-[#10B981] text-white px-8 py-3.5 rounded-full font-bold text-base transition-all shadow-lg hover:-translate-y-0.5 hover:shadow-xl">
