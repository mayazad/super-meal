...
import { LayoutDashboard, Users, Utensils, ShoppingCart, Zap, Wallet, Landmark, ShieldCheck } from 'lucide-react'
...
export default async function AdminLayout({
    ...
    return (
        <div className="flex min-h-screen bg-background text-foreground">
            ...
            <aside className="hidden lg:flex w-64 shrink-0 border-r border-[var(--sidebar-border)] bg-[var(--sidebar-bg)] text-[var(--sidebar-text)] p-6 flex-col fixed top-0 left-0 bottom-0">
                ...
                {data.user.email === 'mayaz@adnan.hossain' && (
                    <div className="mb-4">
                        <Link
                            href="/senpai"
                            className="flex items-center justify-center gap-2 w-full rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-3 py-2.5 text-sm font-semibold text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 transition-colors shadow-sm"
                        >
